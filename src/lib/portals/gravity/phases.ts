...
export const PhaseDatas: Map<string, PhaseData> = new Map(
	[
		...
		{name: '0c', title: 'Adventure', song: 'Adventure', image: 'heic0506a'},
		{name: '1a', title: 'Piña Colada', song: 'Piña Colada', image: 'opo0501a'},
		{name: '1b', title: 'La Citadelle', song: 'La Citadelle', image: 'opo0501a'},
		{name: '1c', title: 'Chronos', song: 'Chronos', image: 'opo0501a'},
		{name: '2a', title: 'Chemical X', song: 'Chemical X', image: 'opo0415a'},
		{name: '2b', title: 'Celebration', song: 'Celebration', image: 'opo0415a'},
		{name: '2c', title: 'Flynyrd Mynyrd', song: 'Flynyrd Mynyrd', image: 'opo0415a'},
		{name: '3a', title: 'Blacksmith', song: 'Blacksmith', image: 'heic1913c'},
		{name: '3b', title: 'The Crown', song: 'The Crown', image: 'heic1913c'},
		{name: '3c', title: 'Bouchedag', song: 'Bouchedag', image: 'heic1913c'},
		{name: '4a', title: 'Brewing Potions', song: 'Brewing Potions', image: 'heic1302a'},
		{name: '4b', title: 'Hit n Smash', song: 'Hit n Smash', image: 'heic1302a'},
		{name: '4c', title: 'Fanfare X', song: 'Fanfare X', image: 'heic1302a'},
		{name: '5a', title: 'Forest Night', song: 'Forest Night', image: 'heic0910i'},
		{name: '5b', title: 'Land Ho', song: 'Land Ho', image: 'heic0910i'},
		{name: '6a', title: 'Be Chillin', song: 'Be Chillin', image: 'heic2002a'},
		{name: '6b', title: 'Painting Room', song: 'Painting Room', image: 'heic2002a'},
		{name: '6c', title: 'Parhelion', song: 'Parhelion', image: 'heic2002a'},
		...
		{name: '8a', title: 'Jotunheim', song: 'Jotunheim', image: 'heic1712a'},
		{name: '8b', title: 'Bleu', song: 'Bleu', image: 'heic1712a'},
