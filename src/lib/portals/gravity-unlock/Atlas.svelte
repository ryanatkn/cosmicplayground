<script lang="ts">
	import {
		...
		PhaseDatas,
		toPhaseSequence,
	} from '$lib/portals/gravity-unlock/phases';
	import Level from '$lib/portals/gravity-unlock/Level.svelte';
	import Phase from '$lib/portals/gravity-unlock/Phase.svelte';
	import LevelButtons from '$lib/portals/gravity-unlock/LevelButtons.svelte';
